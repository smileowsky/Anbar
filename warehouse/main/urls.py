...
urlpatterns = [
    ...
    path('client_delete_config/<int:id>', views.client_delete_config, name='client_delete_config'),
    ...
    path('expens_delete_config/<int:id>', views.expens_delete_config, name='expens_delete_config'),
    ...
    path('products_delete_config/<int:id>', views.products_delete_config, name='products_delete_config'),
    ...
    path('orders_delete_config/<int:id>', views.orders_delete_config, name='orders_delete_config'),
    ...
    path('department_del_conf/<int:id>', views.department_del_conf, name='department_del_conf'),
    ...
    path('position_del_conf/<int:id>', views.position_del_conf, name='position_del_conf'),
    ...
    path('document_delete/<int:doc_id>', views.document_delete, name='document_delete'),
    ...
    path('assignment_del/<int:assign_id>', views.assignments_del, name='assignment_del'),
    path('assignment_del_conf/<int:assign_id>', views.assignments_del_conf, name='assignment_del_conf'),
    path('assignment_edit/<int:assign_id>', views.assignment_edit, name='assignment_edit'),
    path('assignment_update<int:assign_id>', views.assignment_update, name='assignment_update'),
    path('assignment_approve/<int:assign_id>', views.assignments_approve, name='assignment_approve' ),
    path('assignment_cancel/<int:assign_id>', views.assignment_cancel, name='assignment_cancel'),

    path('supplier', views.supplier, name='supplier'),
    path('supplier_delete/<int:supp_id>', views.supplier_delete, name='supplier_delete'),
    path('supplier_del_conf/<int:supp_id>', views.supplier_del_conf, name='supplier_del_conf'),
    path('supplier_edit/<int:supp_id>', views.supplier_edit, name='supplier_edit'),
    path('supplier_update/<int:supp_id>',views.supplier_update, name='supplier_update'),
    ]
